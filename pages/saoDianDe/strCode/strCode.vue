<template>
	<view class="strCode flex-xn-ys">
		<uni-nav-bar :style="{ 'padding-top': safeAreaTop*2+'rpx' }" left-icon="back" @click-left="back" title="串码抽奖"></uni-nav-bar>
		<view class="strCode-center">
			<view class="submitBox">
				...
				<view class="scc-mobile">温馨提示：先输入瓶盖二维码上方6位字符，再输入瓶盖二维码下方6位字符，输入完成后点击“领取红包”按钮</view>
				<view class="submitBox-submit vmdChuanmatijiao" @click="submitForm">领取红包</view>
			</view>
			<view class="flex-xc-yn">
				<image mode="widthFix" class="stc-crownCookies" :src="commonImg+'strcodeLogo.png'"></image>
			</view>
		</view>
		...
		<!-- 自定义 弹窗 -->
		<custom-dialog :customDialogIsShow="customDialogIsShow" :customDialogType="customDialogType" @customDialogColse='updateCustomDialog'></custom-dialog>
...
<style scoped lang="scss">
	...
	.strCode-center {
		...
		background: #fff;
		padding: 96rpx 44rpx 30rpx 44rpx;
		border-radius: 20rpx;
		position: relative;
