...
/***/ 12:
/*!*****************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/山东小程序/sdqp/store/index.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _api = _interopRequireDefault(__webpack_require__(/*! @/utils/api.js */ 8));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _slicedToArray(arr, i) {return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest();}function _nonIterableRest() {throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}function _unsupportedIterableToArray(o, minLen) {if (!o) return;if (typeof o === "string") return _arrayLikeToArray(o, minLen);var n = Object.prototype.toString.call(o).slice(8, -1);if (n === "Object" && o.constructor) n = o.constructor.name;if (n === "Map" || n === "Set") return Array.from(n);if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen);}function _arrayLikeToArray(arr, len) {if (len == null || len > arr.length) len = arr.length;for (var i = 0, arr2 = new Array(len); i < len; i++) {arr2[i] = arr[i];}return arr2;}function _iterableToArrayLimit(arr, i) {if (typeof Symbol === "undefined" || !(Symbol.iterator in Object(arr))) return;var _arr = [];var _n = true;var _d = false;var _e = undefined;try {for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) {_arr.push(_s.value);if (i && _arr.length === i) break;}} catch (err) {_d = true;_e = err;} finally {try {if (!_n && _i["return"] != null) _i["return"]();} finally {if (_d) throw _e;}}return _arr;}function _arrayWithHoles(arr) {if (Array.isArray(arr)) return arr;}_vue.default.use(_vuex.default);
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    userPhone: function userPhone(state, data) {
      state.phoneNumber = data;
    },
    getOpenid: function getOpenid(state, data) {
      state.openid = data;
    },
    getHbopenid: function getHbopenid(state, data) {
      state.hbopenid = data;
    },
    xcxopenid: function xcxopenid(state, data) {
      state.xcxopenid = data;
    },
    session_key: function session_key(state, data) {
      state.session_key = data;
    },
    getQr: function getQr(state, data) {
      state.qr = data;
    },
    getQrcode: function getQrcode(state, data) {
      state.qrcode = data;
    },
    getProvinceCode: function getProvinceCode(state, data) {
      state.provinceCode = data;
    },
    isIPX: function isIPX(state, data) {
      state.isIPX = data;
    },
    getTelNum: function getTelNum(state, data) {
      state.telNum = data;
    },
    ...
    sweepQr: function sweepQr(state, sweep) {
      state.sweepData = sweep;
    },
    COMMITORDER: function COMMITORDER(state, data) {
      state.orderInfo = order;
    },
    addCart: function addCart(state, data) {
      state.cart = data;
    },
    updateOpenScan: function updateOpenScan(state, data) {
      state.openScan = data;
    } },

  actions: {
    sweepResult: function sweepResult(_ref, data) {var commit = _ref.commit;
      commit('sweepQr', data);
    },
    commitOrder: function commitOrder(_ref2, data) {var commit = _ref2.commit;
      commit('COMMITORDER', data);
    },

    getXcxOpenid: function getXcxOpenid() {//获取小程序openid
      return new Promise(function (resolve, reject) {
        ...
        then(function (res) {var _res = _slicedToArray(
          ...
          if (res) {var _res2 = _slicedToArray(
    ...
    getHbOpenid: function getHbOpenid(store, appid) {
      var k = 'hbopenid_';
      if (appid) {
        k += appid;
      } else {
        k += _api.default.payAppid;
      }
      console.log(k);
      return uni.getStorage({
        key: k });
...
/***/ 14:
/*!******************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/山东小程序/sdqp/filter/index.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var filter = {
  ...
  imgUrlSplit: function imgUrlSplit(str) {
    if (str) {
      return str.split(',')[0];
    }
  },
  timeSplit: function timeSplit(str) {
    if (str) {
      return str.split('.')[0];
    }
  },

  tradeSplit: function tradeSplit(str) {
    if (str) {
...
filter;exports.default = _default;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.getLocation = getLocation;exports.analysisMobile = analysisMobile;exports.getUserInfo = getUserInfo;exports.callPhone = callPhone;exports.wxScanCode = wxScanCode;exports.navigateToMiniProgram = navigateToMiniProgram;exports.getSettingLocation = exports.getOpenid = exports.getCode = exports.checkSession = void 0;
...
function getCityInfo() {return new Promise(function (resolve, reject) {wx.getLocation({ success: function success(data) {var url = 'http://api.map.baidu.com/geocoder?location=纬度,经度&output=输出格式类型&key=用户密钥';var latitude = data.latitude,longitude = data.longitude;wx.request({ url: 'https://api.map.baidu.com/geocoder', method: 'GET', dataType: 'json', data: { key: '4ATeuGLwAt08UunArKywQ1KyYalvpdi8', location: latitude + ',' + longitude, output: 'json' }, success: function success(data) {resolve(data.data.result);}, fail: function fail(err) {reject(err);} });}, fail: function fail(error) {reject(error);} });});} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        * 获取用户 基础信息
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        */function getUserInfo() {var _this = this;return new Promise(function (resolve, reject) {var that = _this;uni.getUserInfo({ success: function success(res) {console.log(res);resolve(res); // 存储 头像 昵称 等 基础信息
        uni.setStorage({ key: 'userInfo', data: res.userInfo });}, fail: function fail(err) {reject(err);} });});} /**
                                                                                                                    * 获取用户 位置信息
                                                                                                                    */function getLocation() {var _this2 = this;return new Promise(function (resolve, reject) {var that = _this2;uni.getLocation({ type: 'wgs84', complete: function complete(res) {// 经度 longitude
        // 维度 latitude
        //精度 accuracy
        if (res.errMsg == "getLocation:ok") {resolve([0, res]); // 存储 用户 位置信息
          var data = res || {};uni.setStorageSync('userLocation', data);} else if (res.errMsg == 'getLocation:fail auth deny' || res.errMsg == 'getLocation:fail authorize no response') {//未授权
          resolve([1]); //获取授权
        } else if (res.errMsg == 'getLocation:fail:auth denied') {//取消授权
          resolve([2]);} else {// 未打开定位也要允许扫码
          resolve([3]);}} });});} /**
                                   * 解析用户手机号
                                   */function analysisMobile(session_key, encryptionData) {var that = this;return new Promise(function (resolve, reject) {var params = { 'sessionKey': session_key, 'encryptedData': encryptionData.encryptedData, 'iv': encryptionData.iv, 'provinceCode': 'sdqp' };uni.request({ url: 'https://xcxact.vjifen.com/api/decrypt', method: 'POST', data: params, success: function success(res) {console.log(res);var backData = res.data.data.decryptData;uni.setStorage({ key: 'userMobileData', data: backData });resolve(backData);}, fail: function fail(err) {uni.showModal({ title: '提示', content: '解析手机号结果' + res.data });reject('decrypt', err);} });});} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  * //检测session是否过期
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  *	//0未过期 1已过期
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  */var checkSession = function checkSession() {var promise = new Promise(function (resolve, reject) {uni.checkSession({ success: function success() {console.log('状态未过期'); //未过期
        resolve(0);}, fail: function fail() {console.log('状态已过期'); //已过期
        resolve(1);} });}).catch(function (res) {uni.showToast({ icon: 'none', title: res.errMsg || '验证session失效', duration: 2000 });});return promise;}; // 获取 code 
exports.checkSession = checkSession;var getCode = function getCode() {var promise = new Promise(function (resolve, reject) {uni.login({ success: function success(loginRes) {if (loginRes && loginRes.code) {resolve(loginRes.code);} else {reject(loginRes);}} });}).catch(function (res) {uni.showToast({ icon: 'none', title: res.errMsg || '获取code失败', duration: 2000 });});return promise;}; //验证授权状态 2未操作 1已经授权  0拒绝授权
exports.getCode = getCode;var getSetting = function getSetting() {var promise = new Promise(function (resolve, reject) {uni.getSetting({ success: function success(res) {var authSetting = res.authSetting; //授权成功
        if (authSetting['scope.userInfo']) {resolve(1);return;} //拒绝授权
        if (authSetting['scope.userInfo'] === false) {resolve(0);return;}resolve(2);}, fail: function fail(res) {reject(res);} });}).catch(function (res) {uni.showToast({ icon: 'none', title: res.errMsg || '获取授权状态失败', duration: 2000 });});return promise;}; //验证位置 状态 2未操作 1已经授权  0拒绝授权
var getSettingLocation = function getSettingLocation() {var promise = new Promise(function (resolve, reject) {uni.getSetting({ success: function success(res) {var authSetting = res.authSetting; //授权成功
        if (authSetting['scope.userLocation']) {resolve(1);return;} //拒绝授权
        if (authSetting['scope.userLocation'] === false) {resolve(0);return;}resolve(2);}, fail: function fail(res) {reject(res);} });}).catch(function (res) {uni.showToast({ icon: 'none', title: res.errMsg || '获取位置状态失败', duration: 2000 });});return promise;}; /**
                                                                                                                                                                                                                                                                      * 用 code 交换 openid session_key
                                                                                                                                                                                                                                                                      */exports.getSettingLocation = getSettingLocation;var getOpenid = function getOpenid() {var code = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';var provinceCode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';var sendUrl = 'https://xcxact.vjifen.com/api/getOpenid';var sendData = { code: code, provinceCode: provinceCode };var promise = new Promise(function (resolve, reject) {uni.request({ url: sendUrl, method: 'POST', data: sendData, success: function success(result) {var backData = result.data;if (backData.code == 0) {//储存用户信息到本地
          var data = backData.data || {};uni.setStorageSync('userData', data);resolve(backData.data);} else {console.log(2);resolve(result.msg);}}, fail: function fail(error) {reject(error);} });});return promise;}; // 拨打电话
/**
 * 拨打电话 - 可简单封装工具集
 */exports.getOpenid = getOpenid;function callPhone(phoneNumber) {uni.makePhoneCall({ phoneNumber: phoneNumber, success: function success() {console.log("拨打电话成功！");}, fail: function fail() {console.log("拨打电话失败！");} });} // 扫一扫
function wxScanCode() {uni.scanCode({ success: function success(res) {console.log('条码类型：' + res.scanType);console.log('条码内容：' + res.result);uni.setStorage({ key: "codeData", data: res });uni.setStorage({ key: "sweepstr", data: res.result });var dateStatus = (0, _basicsFun.dateformat)(_api.config.startDate);console.log("dateStatus");console.log(dateStatus);console.log(_api.config.startDate);uni.setStorage({ key: "dateStatus", data: dateStatus == true ? '1' : '0' });uni.setStorage({ key: "isInitsweepstr", data: 'true' });getApp().globalData.isInitsweepstr = 'true';if (!dateStatus) {uni.switchTab({ url: '../index/index', complete: function complete() {getApp().globalData.openQrcode = false;} });} else {uni.redirectTo({
...
function navigateToMiniProgram() {
  /**
                                   * 目前 只跳转 二重惊喜 小程序 
                                   * path : 跳转关联小程序app.json配置里面的地址 ?id=123
                                   * extraData : //需要传递给目标小程序的数据，目标小程序可在 App.onLaunch()，App.onShow() 中获取到这份数据。
                                   * envVersion : //**重点**要打开的小程序版本，有效值 develop（开发版），trial（体验版），release（正式版） 
                                   * **/
  uni.navigateToMiniProgram({
    appId: 'wx1e63bbf67dddd854',
    path: 'pages/index/index',
    envVersion: _api.config.envVersion,
    extraData: {
      "openid": getApp().globalData.openid,
      "tel": this.$Store.state.haveTel,
      "serverName": 'shandongagt',
      "longitude": getApp().globalData.longitude,
      "latitude": getApp().globalData.latitude },

    success: function success(res) {//跳转后清楚数据
      // 打开成功

      getApp().globalData.isOpenECJXMiniProgram = true;
...
/***/ 26:
/*!********************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/山东小程序/sdqp/common/getData.js ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function sweepQrcode(sendParams) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    (0, _api.requestPost)('/sweep/sweepQrcode', sendParams).then(function (backParams) {
      uni.hideLoading();
...
function getCaptcha(phonenum) {
  ...
  return new Promise(function (reslove, reject) {
    ...
    (0, _api.requestPost)('/user/getCaptcha', sendParams).then(function (backParams) {
      uni.hideLoading();
      reslove(backParams);
    });
...
function updateUserInfoMobile(openid, phonenum, captcha) {
  ...
  return new Promise(function (reslove, reject) {
    ...
    (0, _api.requestPost)('/user/updateUserInfoMobile', sendParams).then(function (backParams) {
      uni.hideLoading();
      reslove(backParams);
    });
    // url: 'https://mapi.vjifen.com/vjifenInterface/user/getCaptcha',
...
function savePrize(sendParams) {
  ...
  return new Promise(function (reslove, reject) {
    (0, _api.requestPost)('/user/savePrize', sendParams).then(function (res) {
      uni.hideLoading();
      // let [e,r] =res
      console.log(res);
      if (res) {
...
function queryUserHomePage() {
  ...
  var promise = new Promise(function (reslove, reject) {
    (0, _api.requestPost)('/turnaroundDraw/queryUserHomePage', params).then(function (jo) {
...
// 我的红包 列表 
function queryAllGiftsList(openid, currentPage, count) {var searchFlag = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 1;
  ...
  var promise = new Promise(function (reslove, reject) {
    (0, _api.requestPost)('/gifts/queryAllGiftsList', params).then(function (jo) {
      setTimeout(function () {
        uni.hideLoading();
      }, 300);
      if (jo.result.code == 0) {
...
function queryExchangePrizeAllLst(currentPage, count, searchFlag) {
  ...
  var promise = new Promise(function (reslove, reject) {
    (0, _api.requestPost)(sendUrl, params, _api.config.yylg).then(function (jo) {
...
function queryPrizeList(currentPage, count, useStatus) {
  var userData = uni.getStorageSync('openid');
  var openid = userData.openid;
  var sendUrl = '/gifts/queryPrizeList'; // 奖品列表 
  var params = {
    "openid": openid,
    "currentPage": currentPage,
    "count": count,
  ...
  var promise = new Promise(function (reslove, reject) {
    (0, _api.requestPost)(sendUrl, params).then(function (jo) {
...
function getFailCount() {
  ...
  return new Promise(function (reslove, reject) {
    (0, _api.requestPost)('/sweep/getFailCount', sendParams).then(function (res) {
      var backRes = res.result;
      if (backRes.code === '0') {
...
function serialCode(sendParams) {
  return new Promise(function (resolve, reject) {
    ...
    (0, _api.requestPost)('/sweep/serialCode', sendParams).then(function (backParams) {
      // const [e, r] = backParams;
      console.log("backParams");
      console.log(backParams);
      if (backParams) {
...
function giveSpackTx(openid, hbopenid) {//提现
  ...
  return new Promise(function (resolve, reject) {
    ...
    var userMobileData = uni.getStorageSync('userMobileData') || '';
    var phoneNumber = userMobileData.phoneNumber || '';
    ...
    console.log(sendParams);
    (0, _api.requestPost)('/gifts/getGiftspack', sendParams).then(function (backParams) {
      uni.hideLoading();
      // const [e, r] = backParams;
      console.log("giveSpackTx giveSpackTxgiveSpackTxgiveSpackTx");
      console.log(backParams);
      var backResult = backParams.result;
...
function ifremeber() {
  return new Promise(function (resolve, reject) {
    ...
    var openid = userData.openid;
    uni.request({
      url: _api.config.wxUrl + '/wx3/uinfo2?openid=' + openid + '&appid=' + _api.config.appid,
      method: 'GET',
      complete: function complete(res) {
        console.log('关注', res);
...
function getExchangeRecordRequst(queryType, currentPage, count) {
  ...
  var promise = new Promise(function (reslove, reject) {
    (0, _api.requestPost)('/vpoints/vpointsExchange/getExchangeRecord', params).then(function (jo) {
      console.log('getShopGoodsgetShopGoodsgetShopGoodsgetShopGoodsgetShopGoods');
      console.log(jo);
      if (jo.result.code == 0) {
        if (jo.result.businessCode == 0) {
...
/***/ 27:
/*!*************************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/山东小程序/sdqp/common/swiper-mixin.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...

{
  ...
  methods: {
    querySwiperlist: function querySwiperlist(adType) {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _yield$_this$sw_getLo, longitude, latitude, data, res, result, reply;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                  _this.sw_getLocation());case 2:_yield$_this$sw_getLo = _context.sent;longitude = _yield$_this$sw_getLo.longitude;latitude = _yield$_this$sw_getLo.latitude;
                data = {};
                data.longitude = longitude;
                data.latitude = latitude;
                data.projectServerName = 'liaoning';
                data.adType = adType;_context.next = 12;return (

                  (0, _api.requestPost)('/adPub/adInfo', data));case 12:res = _context.sent;
                console.log(res);
                result = res.result, reply = res.reply;if (!(
                result.code === '0' && reply && reply.length)) {_context.next = 19;break;}return _context.abrupt("return",
                reply);case 19:return _context.abrupt("return",

                null);case 20:case "end":return _context.stop();}}}, _callee);}))();

    },

    handleSwiperlist: function handleSwiperlist(swiperList, classBase) {
      var list = swiperList.map(function (item, index) {
        item.className = 'adType_' + classBase + (index + 1);
      });
      return list;
    },

    handleJumpEvent: function handleJumpEvent(target) {var
      jumpType = target.jumpTyp,jumpUrl = target.jumpUrl,picJumpUrl = target.picJumpUrl;
      if (jumpType == '1') {// 跳转webview h5
        uni.navigateTo({
          url: "/pages/module/webview?target=".concat(jumpUrl) });

      } else if (jumpType == '2') {// 跳转一个已有图片的页面
        uni.navigateTo({
          url: "/pages/module/imgWrap?target=".concat(jumpUrl || picJumpUrl) });
    ...
    sw_getLocation: function sw_getLocation() {
      return new Promise(function (resolve, reject) {
        uni.getSetting({
          complete: function complete(res) {
            console.log(res);
...
/***/ 36:
/*!*****************************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/山东小程序/sdqp/components/swiper-mixin.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 4:
/*!*************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/山东小程序/sdqp/pages.json ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 455:
/*!********************************************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/山东小程序/sdqp/components/gaoyia-parse/libs/html2json.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _wxDiscode = _interopRequireDefault(__webpack_require__(/*! ./wxDiscode */ 456));
var _htmlparser = _interopRequireDefault(__webpack_require__(/*! ./htmlparser */ 457));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
...
/***/ 456:
/*!********************************************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/山东小程序/sdqp/components/gaoyia-parse/libs/wxDiscode.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 457:
/*!*********************************************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/山东小程序/sdqp/components/gaoyia-parse/libs/htmlparser.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 463:
/*!**************************************************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/山东小程序/sdqp/components/simple-address/city-data/province.js ***!
  \**************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 464:
/*!**********************************************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/山东小程序/sdqp/components/simple-address/city-data/city.js ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 465:
/*!**********************************************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/山东小程序/sdqp/components/simple-address/city-data/area.js ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 53:
/*!**********************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/山东小程序/sdqp/common/tipConfig.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.giveSpackTxStatusArr = void 0; // 提示 
var giveSpackTxStatusArr = [{
  id: 1,
  businessCode: '1',
  title: '提示',
...

{
  ...
  businessCode: '-2',
  title: '提示',
  content: '提现操作过于频繁' }];exports.giveSpackTxStatusArr = giveSpackTxStatusArr;

/***/ }),

/***/ 8:
/*!***************************************************************!*\
  !*** /Users/pengboli/Desktop/v积分/xcx/山东小程序/sdqp/utils/api.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.requestGet = requestGet;exports.requestPost = requestPost;exports.getCityInfo = getCityInfo;exports.idcardValidate = exports.config = void 0;function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;} // var host = 'https://douban.uieee.com/v2/movie';
...
function request(url, method) {var data = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};var baseUrl = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : config.requestUrl;
  return new Promise(function (resolve, reject) {
    data.projectServerName = 'shandongagt';
    uni.request({
      url: baseUrl + url,
...
function requestGet(url) {var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var baseUrl = arguments.length > 2 ? arguments[2] : undefined;
  return request(url, 'GET', data, baseUrl);
}
function requestPost(url) {var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var baseUrl = arguments.length > 2 ? arguments[2] : undefined;
